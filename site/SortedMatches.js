...
SortedMatches.prototype.dump = function()
{	
	this.sortByName();
...
SortedMatches.prototype.sortById = function(reversed=false)
{
	this.row2pid = [];
	this.pid2row = [];
...
SortedMatches.prototype.sortByName = function(reversed=false)
{
	this.row2pid = [];
	this.pid2row = [];
	const pa = this.matches.pa.slice(0);
...
SortedMatches.prototype.sortByPoints = function(reversed=false)
{
	this.row2pid = [];
	this.pid2row = [];
